 ...
 <div class="w3_content_agilleinfo_inner">
				<div class="agile_featured_movies">
						<div class="inner-agile-w3l-part-head">
					            <h1 style="text-align:center; font-weight: bold; padding-top: 15px;" >Danh Sách Quốc Gia</h1>
						</div>
						
						<hr>
						<ul  class="nav nav-pills">
						  <li class="nav-item">
							<a class="nav-link " href="admin/addquocgia.php">Thêm quốc gia</a>
						  </li>
						  <li class="nav-item">
							<a class="nav-link " href="index.php">Trang chủ</a>
						  </li>
						  <li class="nav-item">
							<a class="nav-link" href="admin/index.php">Tất cả</a>
						  </li>
						  <li class="nav-item">
					...
					<div  role="tabpanel" >
						...
						?>
									<table class="table table-hover" style="text-align:center; margin:auto; ">
										...
										<tbody>
										  <tr>
											<td><?= $row["id_quocgia"] ?></td>
											<td><a href="quocgia.php?id=<?php echo $row["id_quocgia"] ?>">  <span><?= $row['tenquocgia'] ?></span></a></td>
										  </tr>
										</tbody>
										<?php }
										}?>
